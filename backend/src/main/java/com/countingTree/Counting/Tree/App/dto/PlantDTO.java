...
public class PlantDTO {
    ...
    public PlantDTO(Long plantId, LocalDateTime datePlanted,
                    ...
                    Set<PhotoDTO> photos, Set<Long> alertIds) {
    ...
    public Set<PhotoDTO> getPhotos() { return photos; }
    public void setPhotos(Set<PhotoDTO> photos) { this.photos = photos; }
